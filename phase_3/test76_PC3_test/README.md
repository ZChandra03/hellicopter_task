# Test 76: PC–Task And Normative Correlations
...
```powershell
python .\phase_3\test76_PC3_test\pca_checkpoint_ep010.py
python .\phase_3\test76_PC3_test\correlate_pcs_with_task.py
```
...
python .\phase_3\test76_PC3_test\correlate_pcs_with_task.py `
  --input .\phase_3\test76_PC3_test\pca_outputs\pca_ep010_final_timestep_hidden_states.csv
```
