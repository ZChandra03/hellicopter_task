...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--checkpoint", default="final.pt", help="Checkpoint filename.")
    parser.add_argument("--group_key", default=None, help="Variant group, e.g. sigma_1.")
    parser.add_argument("--train_heads", default="both", choices=["rep", "haz", "both"])
    parser.add_argument("--loss_type", default="bce", choices=["reinforce", "bce"])
    parser.add_argument("--seed", type=int, default=0, help="Random seed and default seed_N dir.")
    parser.add_argument("--n_inits", type=int, default=500)
    parser.add_argument("--max_val_trials", type=int, default=1000)
    parser.add_argument("--opt_steps", type=int, default=3000)
    parser.add_argument("--lr", type=float, default=0.01)
    parser.add_argument("--device", default="cuda", help="'cuda', 'cpu', or a torch device string.")
    parser.add_argument("--noise_scale", type=float, default=0.0)
    parser.add_argument("--cluster_eps", type=float, default=1e-3)
    parser.add_argument("--fixed_tol", type=float, default=1e-6)
    parser.add_argument("--slow_tol", type=float, default=1e-3)
    parser.add_argument("--eig_tol", type=float, default=1e-2)
    ...
    parser.add_argument("--model_class", default=DEFAULT_MODEL_CLASS)
