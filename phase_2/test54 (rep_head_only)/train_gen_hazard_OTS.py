...
TRAIN_HEADS = "rep"        # "rep", "haz", or "both"
SEED_START = 0
N_SEEDS = 1
...
def _get_fixed_val_csv(group_key: str) -> str:
    path = os.path.join(VARIANTS_DIR, group_key, "valConfig_0.csv")
...
def train_group(
    ...
    val_df = pd.read_csv(_get_fixed_val_csv(group_key))
