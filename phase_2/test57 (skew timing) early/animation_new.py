...
def animate_group(run_root: str,
    ...
    frames_sorted, frame_labels, acc_by_frame, seed_ids = build_frames(run_root, group_key, head, n_test, include_final)
    ...
    def update(frame_idx: int):
        ...
        title.set_text(f"{run_key} | {group_key} | {head} head | {frame_labels[frame_key]}")
        return list(lines.values()) + [title]
