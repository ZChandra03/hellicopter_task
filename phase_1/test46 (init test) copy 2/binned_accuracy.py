...
MODEL_SPECS = [
    ("scale2p0",   "2x Scale",      "tab:blue"),
    ("scale5p0",   "5x Scale",      "tab:orange"),
    ("scale10p0",  "10x Scale",     "tab:green"),
    ("scale0p5",   "0.5x Scale",    "tab:red"),
    ("scale0p2",   "0.2x Scale",    "tab:purple"),
    ("scale0p1",   "0.1x Scale",    "tab:brown"),
    ("scale1p0",   "1x Scale",      "tab:pink"),
]
